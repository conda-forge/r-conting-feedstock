...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-conting-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13385&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-conting-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-conting` can be installed with:

```
conda install r-conting
```

It is possible to list all of the versions of `r-conting` available on your platform with:
